...
function (_PureComponent) {
  ...
  function Circle() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      var circle = new google.maps.Circle(Object.assign({
        map: _this.context
      }, _this.props.options));
      ...
      _this.setState(function () {
        ...
        _this.state.circle.setMap(_this.context);
...
_defineProperty(Circle, "contextType", _mapContext.default);
