...
function (_PureComponent) {
  ...
  function DrawingManager(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DrawingManager).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      var drawingManager = new google.maps.drawing.DrawingManager(Object.assign({
        map: _this.context
      }, _this.props.options));
      ...
      _this.setState(function () {
        ...
        _this.state.drawingManager.setMap(_this.context);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDrawingMode", function () {
      return _this.state.drawingManager.getDrawingMode();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMap", function () {
      return _this.state.drawingManager.getMap();
    });
...
_defineProperty(DrawingManager, "contextType", _mapContext.default);
