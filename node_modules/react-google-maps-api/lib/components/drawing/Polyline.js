...
function (_PureComponent) {
  ...
  function Polyline() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Polyline)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "registerEvents", []);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      ...
      _this.setState(function () {
        ...
        _this.state.polyline.setMap(_this.context);
...
_defineProperty(Polyline, "contextType", _mapContext.default);
