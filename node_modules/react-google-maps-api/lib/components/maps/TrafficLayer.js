...
function (_PureComponent) {
  ...
  function TrafficLayer() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TrafficLayer)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      var trafficLayer = new google.maps.TrafficLayer(Object.assign({
        map: _this.context
      }, _this.props.options));
      ...
      _this.setState(function () {
        ...
        _this.state.trafficLayer.setMap(_this.context);
...
_defineProperty(TrafficLayer, "contextType", _mapContext.default);
